...
public class GGPOUE4 : ModuleRules
{
	public GGPOUE4(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (Target.Platform == UnrealTargetPlatform.Win64 /*D || Target.Platform == UnrealTargetPlatform.Win32*/)
		{
		...
		else if (Target.Platform == UnrealTargetPlatform.Linux /*D || Target.Platform == UnrealTargetPlatform.LinuxAArch64*/)
        {
